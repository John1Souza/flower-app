...
export default function Header() {
  return (
    <div className="w-full max-w-[1280px] h-[270px] bg-[#fff] mt-20 shadow-[0px_0px_25px_0px_#00000025] rounded-2xl">
      <div className="w-full h-2/3 flex items-center justify-around">
        ...
        <div className="w-[525px] max-w-2/4 h-[80px] flex items-center justify-center shadow-[0px_0px_25px_0px_#00000025] rounded-2xl">
          <p className="w-full h-full flex items-center justify-center text-base gap-[15px]">
            <PhoneIcon className="size-6 text-black-500" />
            15 99999-999
          </p>
